...
import com.safra.databinding.RecyclerOverviewVisitListBinding;
import com.safra.databinding.RecyclerOverviewVisitListBinding;
...
public class OverviewActiveVisitListRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final OverviewActiveVisitListRecyclerAdapter.OnItemClickListener listener;
    ...
    public OverviewActiveVisitListRecyclerAdapter(Context context, FragmentManager fragmentManager, OverviewActiveVisitListRecyclerAdapter.OnItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ACTIVE_VISITS) {
            RecyclerOverviewVisitListBinding binding = RecyclerOverviewVisitListBinding.inflate(inflater, parent, false);
            return new OverviewActiveVisitListRecyclerAdapter.OverviewActiveVisitListViewHolder(binding);
        } else {
            ItemLoadingBinding binding = ItemLoadingBinding.inflate(inflater, parent, false);
            return new OverviewActiveVisitListRecyclerAdapter.ProgressViewHolder(binding);
        }
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof OverviewActiveVisitListRecyclerAdapter.OverviewActiveVisitListViewHolder)
            ((OverviewActiveVisitListRecyclerAdapter.OverviewActiveVisitListViewHolder) holder).bindView(userList.get(position));
    }
...
//            }
    ...
    class OverviewActiveVisitListViewHolder extends RecyclerView.ViewHolder {
        RecyclerOverviewVisitListBinding binding;

        public OverviewActiveVisitListViewHolder(@NonNull RecyclerOverviewVisitListBinding binding) {

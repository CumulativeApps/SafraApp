...
import com.safra.databinding.RecyclerDiagnosticsListBinding;
...
public class DiagnosticsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final DiagnosticsListAdapter.OnItemClickListener listener;

    public DiagnosticsListAdapter(Context context, DiagnosticsListAdapter.OnItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_PATIENT) {
            RecyclerDiagnosticsListBinding binding = RecyclerDiagnosticsListBinding.inflate(inflater, parent, false);
            return new DiagnosticsListAdapter.DiagnosticsListViewHolder(binding);
        } else {
            ItemLoadingBinding binding = ItemLoadingBinding.inflate(inflater, parent, false);
            return new DiagnosticsListAdapter.ProgressViewHolder(binding);
        }
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof DiagnosticsListAdapter.DiagnosticsListViewHolder)
            ((DiagnosticsListAdapter.DiagnosticsListViewHolder) holder).bindView(userList.get(position));
    }
    ...
    class DiagnosticsListViewHolder extends RecyclerView.ViewHolder {
        RecyclerDiagnosticsListBinding binding;

        public DiagnosticsListViewHolder(@NonNull RecyclerDiagnosticsListBinding binding) {

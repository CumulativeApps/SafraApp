...
public class UserCustomSpinnerAdapter extends RecyclerView.Adapter<UserCustomSpinnerAdapter.OptionViewHolder> {
    ...
    public UserCustomSpinnerAdapter(@NonNull Context context, @NonNull List<UserItem> objects, OnItemClickListener listener) {

...
public class McqRecyclerAdapter extends RecyclerView.Adapter<McqRecyclerAdapter.RadioViewHolder> {
    ...
    public McqRecyclerAdapter(Context context, List<OptionItem> options, boolean isClickable, OnItemClickListener listener) {
    ...
    public McqRecyclerAdapter(Context context, List<OptionItem> options, int selectedPosition) {
        this.context = context;
        this.options = options;

...
import com.safra.databinding.RecyclerActionPlanBinding;
...
public class ActionPlanRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final ActionPlanRecyclerAdapter.OnItemClickListener listener;

    public ActionPlanRecyclerAdapter(Context context, ActionPlanRecyclerAdapter.OnItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_PROJECT) {
            RecyclerActionPlanBinding binding = RecyclerActionPlanBinding.inflate(inflater, parent, false);
            return new ActionPlanRecyclerAdapter.ActionPlanViewHolder(binding);
        } else {
            ItemLoadingBinding binding = ItemLoadingBinding.inflate(inflater, parent, false);
            return new ActionPlanRecyclerAdapter.ProgressViewHolder(binding);
        }    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ActionPlanRecyclerAdapter.ActionPlanViewHolder)
            ((ActionPlanRecyclerAdapter.ActionPlanViewHolder) holder).bindView(userList.get(position));
    }
    ...
    class ActionPlanViewHolder extends RecyclerView.ViewHolder {
        RecyclerActionPlanBinding binding;

        public ActionPlanViewHolder(@NonNull RecyclerActionPlanBinding binding) {

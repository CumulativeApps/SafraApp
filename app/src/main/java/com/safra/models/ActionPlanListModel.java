...
public class ActionPlanListModel {
    ...
    public ActionPlanListModel withSuccess(Integer success) {
        this.success = success;
        return this;
    }
    ...
    public ActionPlanListModel withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public ActionPlanListModel withData(Data data) {
        this.data = data;
        return this;
    }

...
public class TelephoneFieldViewHolder extends BaseFieldViewHolder {

    FormElementTelephoneBinding binding;

    private final HandlerClickListener handlerClickListener;
    private final boolean isPreview;
    private final boolean isReadOnly;

    public TelephoneFieldViewHolder(@NonNull FormElementTelephoneBinding binding, HandlerClickListener handleListener,
        ...
        if(isPreview) {
            ...
            binding.mcvTelephoneElement.setCardElevation(0f);
        } else

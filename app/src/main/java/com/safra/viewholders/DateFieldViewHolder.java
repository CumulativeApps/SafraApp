...
public class DateFieldViewHolder extends BaseFieldViewHolder {

    FormElementDateBinding binding;
    ...
    public DateFieldViewHolder(@NonNull FormElementDateBinding binding, ReloadListener reloadListener,
        ...
        if (isPreview) {
            ...
            binding.mcvDateElement.setCardElevation(0f);
        } else
    ...
    public void bind(Activity context, BaseFormElement baseFormElement) {
        sdfDate = new SimpleDateFormat(DATE_FORMAT, Locale.getDefault());
        currentDate = Calendar.getInstance();
        if (baseFormElement.getFieldValue() != null) {
            try {
                currentDate.setTime(Objects.requireNonNull(sdfDate.parse(baseFormElement.getFieldValue())));
        ...
        datePickerDialog = new DatePickerDialog(context,
                (view, year, month, dayOfMonth) -> {
                    ...
                    String currentValue = baseFormElement.getFieldValue();
                    String newValue = sdfDate.format(currentDate.getTime());

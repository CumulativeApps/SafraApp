...
public class EmailFieldViewHolder extends BaseFieldViewHolder {

    FormElementEmailBinding binding;

    private final HandlerClickListener handlerClickListener;
    private final boolean isPreview;
    private final boolean isReadOnly;

    public EmailFieldViewHolder(@NonNull FormElementEmailBinding binding, HandlerClickListener handleListener,
        ...
        if (isPreview) {
            ...
            this.binding.mcvEmailElement.setCardElevation(0f);
        } else

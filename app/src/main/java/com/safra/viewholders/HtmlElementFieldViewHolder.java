...
import com.safra.databinding.FormHtmlElementBinding;
...
public class HtmlElementFieldViewHolder extends BaseFieldViewHolder {

    FormHtmlElementBinding binding;

    private final HandlerClickListener handlerClickListener;
    private final boolean isPreview;
    private final boolean isReadOnly;

    public HtmlElementFieldViewHolder(@NonNull FormHtmlElementBinding binding, HandlerClickListener handleListener,
        ...
        if (isPreview) {
            ...
            this.binding.mcvHtmlElement.setCardElevation(0f);
        } else {
...
//                if (isPreview) {
                    ...
                    if (currentValue != null) {
                        if (!currentValue.equals(string)) {
                            ...
                            Log.e("HtmlElementViewHolder", "onTextChanged: " + baseFormElement.getFieldValue());
                        }
//                    }
                }
            }
            ...
            private void updatePreview() {
                String htmlText = binding.etField.getText().toString();



                    baseFormElement.setFieldValue(htmlText);

                    Log.e("HtmlElementViewHolder", "onTextChanged: " + baseFormElement.getFieldValue());

                binding.previewWebView.loadDataWithBaseURL(null, htmlText, "text/html", "UTF-8", null);
            }
        });

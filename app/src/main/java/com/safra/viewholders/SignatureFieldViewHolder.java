...
import com.safra.R;
import com.safra.databinding.FormElementSignatureBinding;
...
public class SignatureFieldViewHolder extends BaseFieldViewHolder {

    FormElementSignatureBinding binding;

    private final HandlerClickListener handlerClickListener;
    private final boolean isPreview;
    private final boolean isReadOnly;

    public SignatureFieldViewHolder(@NonNull FormElementSignatureBinding binding, HandlerClickListener handleListener,
        ...
        if (isPreview) {
            ...
            this.binding.mcvSignatureElement.setCardElevation(0f);
        } else {
...
//                context.getString(R.string.please_fill_this_field)));
        String string = Jsoup.parse(toString()).text();
        if (isPreview) {
            ...
            if (currentValue != null) {
                if (!currentValue.equals(string)) {
                    ...
                    Log.e("SignaturFieldViewHolder", "onTextChanged: " + baseFormElement.getFieldValue());
                }
            }
        }
...
//                            baseFormElement.setFieldValue(string);
//
//                            Log.e("SignatureFieldViewHolder", "onTextChanged: " + baseFormElement.getFieldValue());
//                        }
//                    }
//                }
//            }

...
public class NumberFieldViewHolder extends BaseFieldViewHolder {

    FormElementNumberBinding binding;

    private final HandlerClickListener handlerClickListener;
    private final boolean isPreview;
    private final boolean isReadOnly;

    public NumberFieldViewHolder(@NonNull FormElementNumberBinding binding, HandlerClickListener handleListener,
        ...
        if (isPreview) {
            ...
            binding.mcvNumberElement.setCardElevation(0f);
        } else

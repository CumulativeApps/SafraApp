...
public class QuizMcqFieldViewHolder extends BaseFieldViewHolder {
    ...
    public QuizMcqFieldViewHolder(@NonNull FormElementRadioGroupBinding binding, ReloadListener listener,

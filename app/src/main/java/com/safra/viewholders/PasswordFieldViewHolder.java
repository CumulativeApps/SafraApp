...
public class PasswordFieldViewHolder extends BaseFieldViewHolder {

    FormElementPasswordBinding binding;

    private final HandlerClickListener handlerClickListener;
    private final boolean isPreview;
    private final boolean isReadOnly;

    public PasswordFieldViewHolder(@NonNull FormElementPasswordBinding binding, HandlerClickListener handleListener,
        ...
        if(isPreview) {
            ...
            binding.mcvPasswordElement.setCardElevation(0f);
        } else

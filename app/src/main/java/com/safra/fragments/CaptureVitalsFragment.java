...
public class CaptureVitalsFragment extends Fragment {
    public static final String TAG = "capture_vitals_fragment";
    private FragmentActivity mActivity = null;

    private FragmentCaptureVitalsBinding binding;

    private final List<PatientListModel.Data.Patient> userList = new ArrayList<>();
    private CaptureVitalsRecyclerAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCaptureVitalsBinding.inflate(inflater, container, false);
...
//                getUsersFromDB();
        ...
        binding.rvCaptureVitals.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override

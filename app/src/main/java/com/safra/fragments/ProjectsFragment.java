...
public class ProjectsFragment extends Fragment {
    public static final String TAG = "project_fragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new ProjectRecyclerAdapter(mActivity, new ProjectRecyclerAdapter.OnItemClickListener() {
            @Override
            ...
            public void onEdit(ProjectListResponseModel item, int position) {
                ...
                i.putExtra("project_id", item.getId());
...
//                                            projectListResponseModel.setUserProfile(user.getString("user_image_url"));
//                                        }
//
//                                        if (user.has("user_module_ids") && !user.isNull("user_module_ids")) {
//                                            projectListResponseModel.setModuleIds(GeneralExtension
//                                                    .toLongArray(user.getString("user_module_ids"), ","));
//                                        }
//
//                                        if (user.has("user_permission_ids") && !user.isNull("user_permission_ids")) {
//                                            projectListResponseModel.setPermissionIds(GeneralExtension
